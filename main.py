...
class Problem:
    ...
    get_conditional_probabilities(R, P, parents).
        Returns a dictionary where the keys are the rooms names and the values are dictionaries of a truth table and the conditional probabilities of the rooms nodes.
    get_evidence(S, M)
        Initializes the attribute evidence.
